...
#define VOL_1000 1000000
	...
	if (On) {
		...
		// ---> gc5025
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC5025MIPI_RAW, currSensorName))&&(0==pinSetIdx)){
			
			printk("LQ -->  enter gc5025 power on.1\n");
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
			...
			printk("LQ -->  enter gc5025 power on.2\n");
			 
		}
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC030AMIPI_RAW, currSensorName))&&(1==pinSetIdx)){
			
			printk("LQ -->  enter gc030a_sub power on.1\n");
...
//				mtkcam_gpio_set(pinSetIdx, CAMRST, pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_OFF]);
			...
			printk("LQ -->  enter gc030a_sub power on.2\n");
			 
		}
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC2385MIPI_RAW_SUB, currSensorName))&&(1==pinSetIdx)){
			
			printk("LQ -->  enter gc2385_sub power on.1\n");

			if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
			...
			mdelay(15);
#endif
			printk("LQ -->  enter gc2385_sub power on.2\n");
			 
		}

		//gc2385
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC2385MIPI_RAW, currSensorName))&&(0==pinSetIdx)){
			
			printk("LQ -->  enter gc2385 power on.1\n");
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
			...
			mdelay(15);
#endif 
			printk("LQ -->  enter gc2385 power on.2\n");
			 
		}


		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_SP250a_MIPI_RAW, currSensorName))&&(0==pinSetIdx)){
			
			printk("LQ -->  enter gc250a power on.1\n");
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
			...
			printk("LQ -->  enter gc250a power on.2\n");
			 
		}

		else if(currSensorName &&(0 == strcmp(SENSOR_DRVNAME_SP250a_MIPI_RAW_SUB, currSensorName))&&(1==pinSetIdx)){
			
			printk("LQ -->  enter gc250a_sub power on.1\n");
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
			...
			printk("LQ -->  enter gc250a_sub power on.2\n");
			 
		}
		
		else if(currSensorName &&(0 == strcmp(SENSOR_DRVNAME_SP0A09_MIPI_RAW, currSensorName))&&(1==pinSetIdx)){
			
			//printk("enter gc0a09_sub power on.1\n");
			printk("=====>%s %s %d POWERON START currSensorName=%s pinSetIdx=%d=====>\n",__FILE__,__func__,__LINE__,currSensorName,pinSetIdx);
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[1 - pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(1 - pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
			...
			mdelay(15);
#endif 
			printk("=====>%s %s %d POWERON END currSensorName=%s pinSetIdx=%d=====>\n",__FILE__,__func__,__LINE__,currSensorName,pinSetIdx);
			//printk("LQ -->  enter gc250a_sub power on.2\n");
			 
		}

		else if (currSensorName
			   && (0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW, currSensorName))&&(0==pinSetIdx)) {
			   //printk("LQ --->  power on ov5648 \n");
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN,
						pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		if (pinSetIdx == 0)
	      ...
	      if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC2385MIPI_RAW_SUB, currSensorName))&&(1==pinSetIdx)){
		...
		//gc5025	
			...
			printk("LQ ----> power off  gc5025 -2 \n");

		}
		else if(currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC030AMIPI_RAW, currSensorName))&&(1==pinSetIdx)){
			printk("LQ ----> power off  gc030a_sub -1 \n");
			...
			printk("LQ ----> power off  gc030a_sub -2 \n");

		}
		else if(currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC2385MIPI_RAW_SUB, currSensorName))&&(1==pinSetIdx)){
			printk("LQ ----> power off  gc2385_sub -1 \n");
			...
			printk("LQ ----> power off  gc2385_sub -2 \n");

		}
		//gc2385
		else if(currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC2385MIPI_RAW, currSensorName))&&(0==pinSetIdx)){
			printk("LQ ----> power off  gc2385 -1 \n");
			...
			printk("LQ ----> power off  gc2385 -2 \n");

		}
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_SP250a_MIPI_RAW, currSensorName))&&(0==pinSetIdx)){
			printk("LQ ----> power off  gc250a -1 \n");
			...
			printk("LQ ----> power off  gc250a -2 \n");

		}

		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_SP250a_MIPI_RAW_SUB, currSensorName))&&(1==pinSetIdx)){
			printk("LQ ----> power off  gc250a_sub -1 \n");
			...
			printk("LQ ----> power off  gc250a_sub -2 \n");

		}
	//add by ricky
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_SP0A09_MIPI_RAW, currSensorName))&&(1==pinSetIdx)){
			printk("power off  sp0a09_sub -1 \n");
			
			printk("=====>%s %s %d POWEROFF START currSensorName=%s pinSetIdx=%d=====>\n",__FILE__,__func__,__LINE__,currSensorName,pinSetIdx);
			/* Set Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
			...
			printk("=====>%s %s %d POWEROFF END currSensorName=%s pinSetIdx=%d=====>\n",__FILE__,__func__,__LINE__,currSensorName,pinSetIdx);

		}
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC2355_MIPI_RAW, currSensorName))&&(0==pinSetIdx)) {
			printk("zhengbichao ----> power off  2355  \n");
		...
		// add by zhengbc
		else if (currSensorName &&(0 == strcmp(SENSOR_DRVNAME_GC0310_MIPI_YUV, currSensorName))&&(1==pinSetIdx)) {
			printk("zhengbichao ----> power off  0310  \n");
