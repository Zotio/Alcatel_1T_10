...
/*GC*/
UINT32 GC5025MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //add by LQ
UINT32 GC2385MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//add by LQ
UINT32 GC2385MIPI_RAW_SUB_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//add by LQ
...
#endif
#if defined(GC2385MIPI_RAW_SUB)
    {GC2385MIPI_SENSOR_SUB_ID, SENSOR_DRVNAME_GC2385MIPI_RAW_SUB, GC2385MIPI_RAW_SUB_SensorInit},
#endif
#if defined(SP250A_MIPI_RAW)
    {SP250AMIPI_SENSOR_ID, SENSOR_DRVNAME_SP250a_MIPI_RAW, SP250A_MIPI_RAW_SensorInit},
#endif
#if defined(SP250A_MIPI_RAW_SUB)
    {SP250AMIPI_SENSOR_SUB_ID, SENSOR_DRVNAME_SP250a_MIPI_RAW_SUB, SP250A_MIPI_RAW_SUB_SensorInit},
#endif
