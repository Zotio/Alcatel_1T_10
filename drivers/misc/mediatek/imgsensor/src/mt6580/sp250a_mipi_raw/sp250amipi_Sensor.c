...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = 0x250a,//SP250AMIPI_SENSOR_ID,
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
				*sensor_id = SP250AMIPI_SENSOR_ID;
                printk("LQ --> sp250a gpw i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                return ERROR_NONE;
            }
            printk("LQ --> sp250a gpw Read sensor id fail, write id:0x%x id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
