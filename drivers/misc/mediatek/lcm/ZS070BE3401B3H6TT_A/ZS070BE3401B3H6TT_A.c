...
static void init_lcm_registers(void)
{
	...
	data_array[0] = 0x10B21500;
        ...
        dsi_set_cmdq(data_array, 1, 1);
        MDELAY(1);
        data_array[0] = 0xAF821500;
        dsi_set_cmdq(data_array, 1, 1);
        MDELAY(1);
        data_array[0] = 0xDF831500;
        dsi_set_cmdq(data_array, 1, 1);
        MDELAY(1);
        data_array[0] = 0x97841500;
        dsi_set_cmdq(data_array, 1, 1);
        MDELAY(1);
        data_array[0] = 0x9C851500;
        dsi_set_cmdq(data_array, 1, 1);
        MDELAY(1);
	...
	data_array[0] = 0x00023902;
        data_array[1] = 0x000010B2;
        dsi_set_cmdq(data_array, 2, 1);

        data_array[0] = 0x00023902;
        data_array[1] = 0x00008B80;
        dsi_set_cmdq(data_array, 2, 1);

        data_array[0] = 0x00023902;
        data_array[1] = 0x0000FF81;
        dsi_set_cmdq(data_array, 2, 1);
        ...
        data_array[0] = 0x00023902;
        data_array[1] = 0x0000DF83;
        dsi_set_cmdq(data_array, 2, 1);

        data_array[0] = 0x00023902;
        data_array[1] = 0x00009784;
        dsi_set_cmdq(data_array, 2, 1);

        data_array[0] = 0x00023902;
        data_array[1] = 0x00009C85;
        dsi_set_cmdq(data_array, 2, 1);

        data_array[0] = 0x00023902;
        data_array[1] = 0x0000B986;
        dsi_set_cmdq(data_array, 2, 1);
#endif
        MDELAY(1);
...
LCM_DRIVER ZS070BE3401B3H6TT_A_lcm_drv = {
	.name		= "ZS070BE3401B3H6TT_A",
