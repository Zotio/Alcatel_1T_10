...
static struct imgsensor_struct imgsensor = {
	...
	/*auto flicker enable: KAL_FALSE for disable auto flicker, KAL_TRUE
...
static void set_dummy(void)
{
	...
	/* you can set dummy by imgsensor.dummy_line and imgsensor.dummy_pixel, or you can set dummy by
	   imgsensor.frame_length and imgsensor.line_length */
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x3820, 0x92);	/* Vertical flip 0x90 */
	write_cmos_sensor(0x3821, 0x41);	/* Horizontal mirror 0x47 */
