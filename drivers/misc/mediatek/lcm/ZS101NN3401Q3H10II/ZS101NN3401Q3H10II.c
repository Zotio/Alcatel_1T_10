...
static int __init lcm_init(void)
{
	...
	if(strcmp(emdoor_lcm_name, "ZS101NN3401Q3H10II")==0){
...
/*#if (LCM_DSI_CMD_MODE)
		...
		params->dsi.vertical_sync_active				= 6;//4;//2;  //4
		params->dsi.vertical_backporch					= 20;//10;//16;  //4
		params->dsi.vertical_frontporch 				= 20;//30;//9;  //8
		params->dsi.vertical_active_line				= FRAME_HEIGHT;
		
		params->dsi.horizontal_sync_active			= 20;//18;//18;  //14
		params->dsi.horizontal_backporch				= 80;//18;//92;	//140
		params->dsi.horizontal_frontporch				= 80;//18;//92; //16
		params->dsi.horizontal_active_pixel 			= FRAME_WIDTH;


//		params->dsi.ssc_disable = 1;
		params->dsi.PLL_CLOCK = 310;//310;//210;
...
LCM_DRIVER ZS101NN3401Q3H10II_lcm_drv = {
	.name		= "ZS101NN3401Q3H10II",
