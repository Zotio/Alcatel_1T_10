...
static s32 gtp_init_panel(struct i2c_client *client)
{
	...
	config_version = send_cfg_buf[rd_cfg_buf[GTP_ADDR_LENGTH]][0];
#ifdef GTP_CHARGER_DETECT
...
static s32 tpd_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if (gt91xx_config_proc == NULL)
		GTP_ERROR("create_proc_entry gt910 proc file failed\n");
...
#if GTP_CHANGE_X2Y
				temp = input_x;
		                input_x =abs_x_max -  input_y * abs_x_max/abs_y_max;
                		input_y = temp * abs_y_max/abs_x_max;
#endif
